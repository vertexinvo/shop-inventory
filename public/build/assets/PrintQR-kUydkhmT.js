import{q as o,j as e,Y as d,y as l}from"./app-D1k6Qr7D.js";import{Q as g}from"./index-CZXrCO8N.js";import{A as m,M as c}from"./AuthenticatedLayout-C1WX5jBP.js";import"./transition-Db-cRclb.js";import"./ReactToastify-l_hJBn7I.js";import"./Modal-BbiwkvGn.js";const v=({products:a})=>{const r=o().props.setting;return e.jsx(e.Fragment,{children:e.jsxs(m,{header:e.jsxs(e.Fragment,{children:[e.jsx(c,{size:20,className:"mr-2 cursor-pointer text-gray-600 hover:text-gray-800 transition duration-300",onClick:()=>l.get(route("product.index")),title:"Back"}),e.jsx("h2",{className:"font-semibold text-xl text-gray-800 leading-tight",children:"QR Codes"})]}),children:[e.jsx(d,{title:"Purchase"}),e.jsx("style",{children:`
      @media print {
