                ...
                {({ values, setFieldValue, handleSubmit, errors, touched }) => (
                  ...
                  <Form className="flex flex-col md:flex-row space-x-0 md:space-x-2 mt-2 md:mt-0">
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() => { setFieldValue('search', ''); router.get(route('tax.index')) }}
                ...
                <tbody class="whitespace-nowrap">
                  ...
                  {taxs.data.map((tax, index) => (
                    <tr key={tax.id} class="odd:bg-gray-50">
                      ...
                      <td class="p-4">
                        <button onClick={() => router.get(route('tax.edit', tax.id))} class="mr-4" title="Edit">
                        ...
                        <button onClick={() => setIsDeleteModalOpen(tax)} title="Delete">
