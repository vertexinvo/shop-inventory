...
export default function List(props) {
  ...
  return (
    ...
    >
      ...
      <div class="px-5 mx-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mt-10">
                  ...
                  {suppliers.data.map((item, index) => (
                    ...
                    <tr className={`${item?.total_amount_pending > 0 ? 'bg-red-100' : ''}`}>
                      ...
                      <td class="p-4 flex items-center">
                        <button onClick={() => router.get(route('supplier.invoices', item.id))} class="mr-4" title="Edit">
                          <LiaFileInvoiceSolid className='fill-black hover:fill-gray-700' size={25} />
                        </button>
