                  ...
                  {users.data.map((user, index) => (
                    <tr key={user.id} class="odd:bg-gray-50">
                      ...
                      <td class="p-4 flex items-center gap-2">
                        ...
                        <Link href={route('order.index', { searchuserid: user.id })} >
                          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 117.78 122.88" width="23" height="23">
