          ...
          <div className="flex flex-col md:flex-row justify-end items-center mt-2 mb-4">
            ...
            <div className="flex flex-col md:flex-row w-full md:justify-start space-y-2 md:space-y-0 md:space-x-2">
              ...
              {/* <Formik
                ...
                onSubmit={(values) => {
                  router.get(route('brand.index'), { search: values.search }, { preserveState: true });
                }}
              >
                  ...
                  {brands.data.map((brand, index) => (
                    ...
                    <tr class="odd:bg-gray-50">
                      ...
                      <td class=" text-sm">
                        <div class="flex items-center cursor-pointer w-max">
                          <div class="ml-4 ">
                            <p class="text-sm text-black ">{brand.total_products}</p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="flex justify-end py-2 px-4 border-b border-gray-200 text-right">
                        <button onClick={() => router.get(route('brand.edit', brand.id))} className="flex mr-4 items-center space-x-2 bg-blue-500 hover:bg-blue-600 rounded text-white px-3 py-2" title="Edit">
                        ...
                        <button onClick={() => setIsDeleteModalOpen(brand)} title="Delete" className="flex mr-4 items-center space-x-2 bg-red-500 hover:bg-red-600 rounded text-white px-3 py-2">
