      ...
      header={
        <>
          <MdKeyboardBackspace
            ...
            title="Back"
          />
          <h2 className="font-semibold text-xl text-gray-800 leading-tight">User</h2>
        </>}
    >
                  ...
                  {users.data.map((user, index) => (
                    <tr key={user.id} class="odd:bg-gray-50">
                      ...
                      <td className="flex justify-end py-2 px-4 border-b border-gray-200 text-right">
                        <button onClick={() => router.get(route('user.edit', user.id))} className="flex mr-4 items-center space-x-2 bg-blue-500 hover:bg-blue-600 rounded text-white px-3 py-2" title="Edit">
                        ...
                        <button onClick={() => setIsDeleteModalOpen(user)} title="Delete" className="flex mr-4 items-center space-x-2 bg-red-500 hover:bg-red-600 rounded text-white px-3 py-2">
                          ...
                          return (
                            <li key={index}>
                              {isEllipsis ? (
                                ...
                                // Active page button
                                <button
                                  className="px-3 py-1 text-white transition-colors duration-150 bg-black    rounded-md "
                                  aria-current="page"
                                >
                                  {link.label}
                                </button>
