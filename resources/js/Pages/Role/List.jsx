                                            ...
                                            {roles.data.map((item, index) => (
                                                <tr key={item.id} className="hover:bg-gray-100">
                                                    ...
                                                    <td className="flex justify-end py-2 px-4 border-b border-gray-200 text-right">
                                                        ...
                                                        <button
                                                            onClick={() => router.get(route('role.edit', item.id))}
                                                            title="Edit"
                                                            className="mr-4 flex items-center space-x-2 bg-blue-500 hover:bg-blue-600 rounded text-white px-3 py-2"
                                                        >
                                                            <svg
                                                        ...
                                                        <button
                                                            ...
                                                            title="Delete"
                                                            className="mr-4 flex items-center space-x-2 bg-red-500 hover:bg-red-600 rounded text-white px-3 py-2"
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                className="w-5 h-5 fill-black text-white"
