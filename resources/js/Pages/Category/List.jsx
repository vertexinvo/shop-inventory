                ...
                <Form className="flex flex-col md:flex-row space-x-0 md:space-x-2 mt-2 md:mt-0">
                  <div className="relative">
                    <Field
                      ...
                      type="text"
                      placeholder="Search..."
                      className="py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                ...
                <tbody class="whitespace-nowrap">
                  ...
                  {categories.data.map((category, index) => (
                    ...
                    <tr key={category.id} class="odd:bg-gray-50">
                      ...
                      <td class="p-4">
                        <button onClick={() => router.get(route('category.edit', category.id))} class="mr-4" title="Edit">
                        ...
                        <button onClick={() => setIsDeleteModalOpen(category)} title="Delete">
