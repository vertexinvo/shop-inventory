...
import { FaWallet, FaEdit, FaPlus, FaMinus, FaTrash } from 'react-icons/fa'
          ...
          <div className="p-6 sm:p-8">
            <Formik 
              ...
              onSubmit={(values, { setSubmitting, resetForm }) => {
                ...
                router.post(route('product.updatewithimage', product), formData, {
                  forceFormData: true, 
                  onSuccess: ({props}) => { 
              ...
              {({values, errors, touched, setFieldValue, isSubmitting }) => (
                <Form className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <Field
                            ...
                            name="type"
                            id="type"
                            className={`block w-full rounded-md border ${errors.type && touched.type ? 'border-red-300' : 'border-gray-300'} shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2.5 px-3`}
                          >
                    ...
                    {/* Specifications */}
                    <div className="mt-6">
                      <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="specifications">
                        Specifications
                      </label>
                      <ReactQuill
                        theme="snow"
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">Upload or update the product image.</p>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mb-4">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="mt-2 text-xs text-gray-500">Check this box to remove the current image</p>
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="mt-4">
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          {product.image_url && !values.remove_image ? 'Replace Image' : 'Upload Image'}
                        </label>
