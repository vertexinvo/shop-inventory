...
export default function List(props) {
  ...
  return (
      <AuthenticatedLayout
          tax={auth.tax}
          header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Shipping Rate</h2>}
      >
              ...
              {selectId.length > 0 &&
                ...
                >
                  ...
                  <Form className="flex flex-col md:flex-row space-x-0 md:space-x-2 mt-2 md:mt-0">
                    ...
                    <button
                      type="button"
                      onClick={() => {setFieldValue('search', ''); router.get(route('shippingrate.index'))}}
        ...
        >
          ...
          >
            ...
            <td class="p-4">
              ...
              <button onClick={() => setIsDeleteModalOpen(shippingrate)} title="Delete">
